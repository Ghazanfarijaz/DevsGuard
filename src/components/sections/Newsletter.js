        ...
        <div className="max-w-[1440px] mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <form onSubmit={handleSubmit} className="flex flex-col sm:flex-row gap-4 justify-center items-center max-w-3xl mx-auto">
            <input
              ...
              required
              className="bg-[#f8f8f8] text-[#382222] text-[20px] font-medium font-poppins px-6 py-4 rounded-[20px] focus:outline-none focus:ring-2 focus:ring-[#78d5ea] w-full sm:w-[515px]"
            />
            <button
              type="submit"
              className="bg-[#78d5ea] text-[#0c456b] text-[20px] font-medium font-poppins px-8 py-4 rounded-[20px] hover:bg-[#5fc5d8] transition-colors whitespace-nowrap cursor-pointer w-full sm:w-[156px]"
            >
              Subscribe
            </button>
          </form>
      ...
      <div className="max-w-[1440px] mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="max-w-5xl mx-auto bg-[#0c456b] rounded-[35px] p-8 lg:p-12 shadow-lg">
          ...
          <form onSubmit={handleSubmit} className="flex flex-col sm:flex-row gap-4 max-w-3xl mx-auto">
            ...
            <button
              type="submit"
              className="bg-[#78d5ea] text-[#0c456b] text-[20px] font-medium font-poppins px-8 py-4 rounded-[20px] hover:bg-[#5fc5d8] transition-colors whitespace-nowrap cursor-pointer"
            >
              Subscribe
            </button>
          </form>
